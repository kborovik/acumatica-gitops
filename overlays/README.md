...
With host-true `matrix.yaml` cells, omit path args:
...
| Cell id | ERP line | `default_api` | Overlay | Notes |
|---------|----------|---------------|---------|--------|
| `26r1` | 26r1 | `25.200.001` | *(none)* | trunk Production (default cell) |
| `25r1` | 25r1 | `24.200.001` | `default-24.200.001/` | KitAssembly Type Assembly |
| `25r2` | 25r2 | `25.200.001` | *(none)* | trunk Production |
